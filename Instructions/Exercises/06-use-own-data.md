...
1. Dopo aver distribuito il modello di incorporamento del testo, tornare alla pagina **Distribuzioni** e creare una nuova distribuzione del modello **gpt-35-turbo-16k** con le impostazioni seguenti:
    - **Nome della distribuzione**: gpt-35-turbo-16k
